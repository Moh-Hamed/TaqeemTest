var Charts = function() {"use strict";
	...
	var barChartHandler = function() {
		...
		var data = {
			labels: ["عبدالرحمن المفلح","عبدالرحمن المفلح" ,"عبدالرحمن المفلح" ,"عبدالرحمن المفلح" ,"عبدالرحمن المفلح" ,"عبدالرحمن المفلح" , "عبدالرحمن المفلح"],
			datasets: [{
				label: "My First dataset",
				fillColor: "#00a1ff",
				strokeColor: "#00a1ff",
				highlightFill: "#00a1ff",
				highlightStroke: "#00a1ff",
		...
		var data = {
			labels: ["مساعد اداري", "معمد", "مراجعة", "مقيم", "مشرف", "مستقبل"],
			datasets: [{
				label: "My First dataset",
				fillColor: "#D1351F",
				strokeColor: "#D1351F",
				highlightFill: "#D1351F",
				highlightStroke: "#D1351F",
